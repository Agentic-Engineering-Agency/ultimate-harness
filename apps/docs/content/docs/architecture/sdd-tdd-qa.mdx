...
description: "Three composable verification discipline layers — spec-driven acceptance criteria, test-first diff gate, and cross-runtime fan-out comparison — all flowing through the same verification.yaml + events.ndjson pipeline."
---
