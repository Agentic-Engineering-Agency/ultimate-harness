...
| `oh-my-pi` | active | [Anthropic-via-OMP runbook](./runbooks/anthropic-via-omp.md) — covers the Anthropic-via-OMP routing path and its ToS posture; graduated to `active` in v0.8.0. |
