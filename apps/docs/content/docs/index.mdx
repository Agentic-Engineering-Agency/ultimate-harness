...
1. [Quickstart](./quickstart.md) — zero to a verified mission in a few minutes.
2. [Configuration](./configuration.md) — project state, adapters, env vars, per-mission overrides.
3. [Runtime targets](./runtime-targets.md) — per-adapter invocation shapes.
4. [Optional telemetry](./telemetry.md) — opt-in, off by default.
5. [Troubleshooting](./troubleshooting.md) — common issues and fixes.
6. [Plugin development](./plugin-development.md) — the Hermes dashboard plugin.
