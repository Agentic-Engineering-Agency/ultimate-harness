...
| `HONCHO_API_KEY` | Honcho persistent-memory key. Enables the extension when set (unless `HONCHO_ENABLED=false`). See the [Optional telemetry](./telemetry) page and the Honcho runbook in the repo. |
