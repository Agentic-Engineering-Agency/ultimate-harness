...
description: "Last updated: 2026-05-25. Source of truth for issue state is Linear; human-readable epic index for Ultimate Harness."
---

# Ultimate Harness — Roadmap

Source of truth for issue state is [Linear](https://linear.app/agenticengineering-agency/team/UH/active); GitHub mirrors through the native integration. This document describes release objectives and unresolved engineering work. Implemented changes are recorded in the [changelog](https://github.com/Agentic-Engineering-Agency/ultimate-harness/blob/main/CHANGELOG.md).
