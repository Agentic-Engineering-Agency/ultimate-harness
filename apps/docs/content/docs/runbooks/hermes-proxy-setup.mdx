...
description: "Zero-to-`runtime-result.status: passed` for the `hermes-proxy` adapter. Architecture context lives in [`docs/architecture/adapter-hermes-proxy.md`](../architecture/adapter-hermes-proxy); wire-format discovery is in [`docs/architecture/he"
---

Zero-to-`runtime-result.status: passed` for the `hermes-proxy` adapter. Architecture context lives in [`docs/architecture/adapter-hermes-proxy.md`](../architecture/adapter-hermes-proxy); wire-format discovery is in [`docs/architecture/hermes-proxy-spike.md`](../architecture/hermes-proxy-spike).
