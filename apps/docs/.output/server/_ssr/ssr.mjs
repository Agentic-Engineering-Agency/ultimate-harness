...
import { C as isResolvedRedirect, E as isNotFound, S as isRedirect, T as rootRouteId, a as RouterProvider, b as resolveManifestAssetLink, k as invariant, t as renderRouterToStream, v as getStylesheetHref, x as executeRewriteInput } from "../_libs/@tanstack/react-router+[...].mjs";
import { n as createMemoryHistory } from "../_libs/tanstack__history.mjs";
import { a as mergeHeaders, c as createSerializationAdapter, d as Pu, f as iu, i as getOrigin, n as attachRouterServerSsrUtils, p as su, r as getNormalizedURL, s as createRawStreamRPCPlugin, t as defineHandlerCallback } from "../_libs/@tanstack/router-core+[...].mjs";
import { a as X_TSS_RAW_RESPONSE, c as createNullProtoObject, d as getDefaultSerovalPlugins, f as getStartContext, i as TSS_SERVER_FUNCTION, m as safeObjectMerge, n as TSS_CONTENT_TYPE_FRAMED_VERSIONED, o as X_TSS_SERIALIZED, p as runWithStartContext, r as TSS_FORMDATA_CONTEXT, t as FrameType, u as flattenMiddlewares } from "./esm-DaX-Y_xv.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DMMYcLe4.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BnSUtIiz.mjs"),
		import("./start-Cy20KNRY.mjs"),
