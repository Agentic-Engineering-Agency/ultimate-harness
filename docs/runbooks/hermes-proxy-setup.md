...
1. **Hermes Agent ≥ 0.14.0** installed locally.
   ...
   ```
   If the version is older, upgrade per the [Hermes release notes](https://github.com/NousResearch/hermes-agent/releases/tag/v2026.5.16). UH's `hermes` adapter rejects pre-0.14.0 installs ([UH-31](https://linear.app/agenticengineering-agency/issue/UH-31)).
