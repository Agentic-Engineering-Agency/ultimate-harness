...
Two prototypes were built at commit [`8adf04b`](https://github.com/Agentic-Engineering-Agency/ultimate-harness/tree/8adf04b/bin) (see git history — `git show 8adf04b -- bin/`):
