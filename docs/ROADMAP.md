...
Epic 2 (Interactive TUI), Epic 3 (Hermes Dashboard plugin — [UH-60](https://linear.app/agentic-eng/issue/UH-60)), Epic 4 (Team mission shape — [UH-70](https://linear.app/agentic-eng/issue/UH-70)), and Epic 5 (multi-run history + replay — [UH-84](https://linear.app/agentic-eng/issue/UH-84)) all shipped end-to-end through **v0.4.0**. Hermes-plugin follow-ups [UH-81](https://linear.app/agentic-eng/issue/UH-81) / [UH-82](https://linear.app/agentic-eng/issue/UH-82) / [UH-83](https://linear.app/agentic-eng/issue/UH-83) shipped in the same cut. TUI polish ([UH-48](https://linear.app/agentic-eng/issue/UH-48)..[UH-51](https://linear.app/agentic-eng/issue/UH-51)) shipped in [#99](https://github.com/Agentic-Engineering-Agency/ultimate-harness/pull/99). **Next**: Epics 6–8 execution plan in [`docs/specs/epics-6-7-8.md`](./specs/epics-6-7-8.md) (live SSE tail, adapter capability routing, spec-first propose/scaffold). **Blocked**: npm publish for v0.4.0 pending token rotation ([UH-91](https://linear.app/agentic-eng/issue/UH-91)) — GitHub tag + plugin tarball exist; registry upload fails with npm 404 on scoped PUT.
